 ...
 */
 ...
 BlockImageLoader.create = function(left, right, top, renderType, hasNoShadow){
	...
	var fixBug = android.graphics.Bitmap.createBitmap(64, 64, android.graphics.Bitmap.Config.ARGB_8888);
	fixBug.drawBitmap(left, 0, 0, null)
	fixBug.drawBitmap(right, 16, 16, null)
	fixBug.drawBitmap(top, 0, 16, null)

	left = new android.graphics.Bitmap.createBitmap(fixBug, 0, 0, 16, 16)
	right = new android.graphics.Bitmap.createBitmap(fixBug, 16, 16, 16, 16)
	bottom = new android.graphics.Bitmap.createBitmap(fixBug, 0, 16, 16, 16)
