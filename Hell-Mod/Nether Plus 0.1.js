...
UI = {
	UI.openBenchmark = {
		...
		for(c = 9;c <=44; c++){
			...
			UI.benchmark.slots[c].ui = ModPEGUI.imageButton(UI.benchmark.slotsUI.normal(UI.benchmark.slots[c].texture), UI.benchmark.slotsUI.selected(UI.benchmark.slots[c].texture), UI.benchmark.slotsUI.selected(UI.benchmark.slots[c].texture), 24 * UI.benchmark.slots[c].cX, UI.benchmark.slots[c].cY, 22, 22, UI.benchmark.slot[c].function(UI.benchmark.slots[c]));
